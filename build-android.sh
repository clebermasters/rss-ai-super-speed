...
ENV_DEFAULT_AI_CONTENT_FORMATTING_ENABLED="${DEFAULT_AI_CONTENT_FORMATTING_ENABLED:-}"
...
DEFAULT_AI_CONTENT_FORMATTING_ENABLED="${ENV_DEFAULT_AI_CONTENT_FORMATTING_ENABLED:-false}"
...
load_env_file() {
  ...
  while IFS='=' read -r key value || [ -n "$key" ]; do
    ...
    case "$key" in
      ...
      DEFAULT_AI_CONTENT_FORMATTING_ENABLED|AI_CONTENT_FORMATTING_ENABLED) DEFAULT_AI_CONTENT_FORMATTING_ENABLED="$value" ;;
...
if [ -n "$ENV_DEFAULT_AI_CONTENT_FORMATTING_ENABLED" ]; then DEFAULT_AI_CONTENT_FORMATTING_ENABLED="$ENV_DEFAULT_AI_CONTENT_FORMATTING_ENABLED"; fi
